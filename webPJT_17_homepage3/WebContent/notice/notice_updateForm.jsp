...
<%
	...
	// out.print(no); /*번호가 넘어오는 지 확인하는 거*/
...
.board_textarea_H270{
	...
	color :#848484; 
	  ...
	  <form name="noti">
	  	<input type="hidden" name="t_no" value="<%=no%>">
			<table class="bord_table">
				...
				<tbody>
					<tr>
						<th>제 목</th>
						<td colspan="3"><input type="text" name="t_title" value="<%=dto.getTitle()%>" class="t_title" maxlength="30"  /></td>
					</tr>
					<tr>
						<th>내 용</th>
						<td colspan="3">
					...
					<tr>
						<th>등 록 자</th>
						<td>
							<input type="text" value="<%=dto.getReg_name() %>" name="t_reg_name" size="5">
						</td>
	
						<th>등 록 일</th>
						<td>
							<input type="date" value="<%=dto.getReg_date()%>" name="t_reg_date" size="5">
		...
		<div class="paging">
			<a href="javascript:history.back()" class="btn_write">이 전</a>
			<a href="javascript:goUpdate()" class="btn_write">수 정 저 장</a>
		</div>
	  </div>			
