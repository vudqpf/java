...
<%
	...
	ArrayList<News_dto> arr = dao.getNewsList(select, search, sort);
      ...
      <div id="content">
			...
			<form name="news">
				<p class="select_Box">
					...
					<input type="radio" value="no" name="t_sort" <%if(sort.equals("no")) out.print("checked"); %>>번호순
					<input type="radio" value="reg_date" name="t_sort" <%if(sort.equals("reg_date")) out.print("checked"); %>>등록일순
					<!-- radio의 경우 name이 같으면 1개만 체크 가능 -->
...
.paging .btn_write {background:#BDBDBD; padding:10px 16px; color:#fff; float:right;}
	  ...
	  <div class="bord_list">
		<table class="bord_table">
			...
			<%for(int k = 0; k<arr.size(); k++){ %>
				<tr>
					...
					<td class="title"><a href="notice_v.html"><%=arr.get(k).getTitle() %></a></td>
		...
		<div class="paging">
			...
			<a href="news_writeForm.jsp" class="btn_write">글쓰기</a>
		</div>
	  </div>			
