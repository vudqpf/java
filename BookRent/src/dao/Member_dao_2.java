...
public class Member_dao_2 {
	...
	//도서등록
	public int bookInsert(Member_dto_2 dto) {
		int result = 0;
		String query = " INSERT INTO b17_book " + 
			   		   " (no, name, publisher, writer, reg_date)\r\n" + 
				       " VALUES ('"+dto.getNo()+"', '"+dto.getName()+"', '"+dto.getPublicher()+"', '"+dto.getWriter()+"', '"+dto.getReg_date()+"')";
	...
	//도서 수정
	public int updateName(String no, String name, String publisher, String writer, String reg_date) {
		int result = 0;
